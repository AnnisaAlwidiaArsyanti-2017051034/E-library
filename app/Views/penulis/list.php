                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        ...
                        <a class="btn btn-danger btn-circle" href="#" data-toggle="modal" data-target="#hapusModal-<?= $pn['kode_penulis'] ?>"><i class="fas fa-trash"></i></a>
                        
                        <div class="modal fade" id="hapusModal-<?= $pn['kode_penulis'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Hapus Penulis</h5>
                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                        </button>
                                    </div>
                                    <form action="/deletePenulis/<?= $pn['kode_penulis'] ?>" method="post">
                                    <div class="modal-body">Apakah anda yakin ingin menghapus penulis <?= $pn['nama_penulis'] ?>?</div>
